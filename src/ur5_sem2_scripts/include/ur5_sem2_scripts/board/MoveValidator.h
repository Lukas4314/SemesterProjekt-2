...
public:
    ...
    MoveValidator();
    static bool isValidMove(int fromRow, int fromCol, int toRow, int toCol, const vector<vector<char>> &board, const string &activeColor, vector<string> moveHistory);
    ...
    static bool isValidEnPassant(const string &activeColor, const vector<vector<char>> &board, string currentMove, vector<string> moveHistory);
    ~MoveValidator();
private:
    // Function for checking if pawn move is valid (Need to implement isPathClear function)
    static bool isValidPawn(char piece, int fromRow, int fromCol, int toRow, int toCol, const vector<vector<char>> &board, const string &activeColor, vector<string> moveHistory);
    ...
    static bool underAttack(int row, int col, const string &activeColor, const vector<vector<char>> &board, vector<string> moveHistory);
