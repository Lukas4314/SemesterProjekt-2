...
private:
    ...
    const float death_positionsleft[16][2] = {
        {0.80, -0.30}, {0.80, -0.25}, {0.75, -0.30}, {0.75, -0.25},
        {0.70, -0.30}, {0.70, -0.25}, {0.65, -0.30}, {0.65, -0.25},
        {0.60, -0.30}, {0.60, -0.25}, {0.55, -0.30}, {0.55, -0.25},
        {0.50, -0.30}, {0.50, -0.25}, {0.45, -0.30}, {0.45, -0.25}
    };
    const float death_positionsright[16][2] = {
        {0.80, 0.25}, {0.80, 0.20}, {0.75, 0.25}, {0.75, 0.20},
        {0.70, 0.25}, {0.70, 0.20}, {0.65, 0.25}, {0.65, 0.20},
        {0.60, 0.25}, {0.60, 0.20}, {0.55, 0.25}, {0.55, 0.20},
        {0.50, 0.25}, {0.50, 0.20}, {0.45, 0.25}, {0.45, 0.20}
    };
