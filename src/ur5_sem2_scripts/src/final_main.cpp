...
int main(int argc, char *argv[])
{
  ...
  while (true)
  {
    ...
    // Not sure if it needs more, since the vision_main.cpp which most of the code is copied from is up to date since the chessboard.cpp class
    // Development is not finished yet and has changed the vision_main.cpp class
